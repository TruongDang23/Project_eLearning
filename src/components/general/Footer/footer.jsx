        ...
        <Grid container spacing={5}>
          <Grid item xs={12} sm={5}>
            ...
            <Typography variant="body2" color="text.secondary">
              Đây là đồ án Xây dựng website E-learning cho các khóa học về Công Nghệ Thông Tin.
              Ngoài ra có tích hợp các mô hình ML và AI giúp giải quyết những vấn đề tồn đọng trong
              quá trình học online hiện nay. Hiện tại, đồ án đang trong giai đoạn phát triển
              cho Tiểu luận chuyên ngành.
            </Typography>
          </Grid>
          <Grid item xs={12} sm={5}>
            <Typography variant="h6" color="text.primary" gutterBottom>
